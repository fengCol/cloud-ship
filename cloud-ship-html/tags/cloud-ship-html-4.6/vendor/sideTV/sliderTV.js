...
!function (t, i, s) {
    ...
    var n = "sliderTV", o = {animation: {duration: 400, easing: "linear", isVertical: !1}, bullets: {canShow: !0}};
    e.prototype = {
        init: function (i, s) {
            ...
            var i = t(this.element), s = t(i).offset();
            ...
            if (this.options.animation.isVertical === !1) {
                ...
                this._itemDoms.each(function (e, n) {
                    s = t(n).width();
                    var o = {position: "absolute", left: 0.8*i, width:  s/2};
                    t(n).css(o), i += s
                })
            } else {
                var e = 0, n = 0;
                this._itemDoms.each(function (i, s) {
                    n = t(s).height();
                    var o = {position: "absolute", top: e, height: n};
                    t(s).css(o), e += n
                })
            }
            ...
            if (this.options.bullets.canShow !== !1) {
                ...
                this._bulletsDoms.each(function (s, e) {
                    if (s === this._focus) t(e).addClass(i); else {
                        var n = t(e).hasClass();
                        n && t(e).removeClass(i)
                    }
                }.bind(this))
            ...
            var i = t(this.element).find(".sliderTV__next"), s = t(this.element).find(".sliderTV__prev"), e = i.length > 0, n = s.length > 0;
            ...
            if (this._canCheckMovePrevNext) {
                // var i = "visibility", s = "hidden", e = "visible", n = this._itemDoms.length;
                var i = "background-image",a = "url('../../images/hatch/project/prev-01.png')",b = "url('../../images/hatch/project/prev-02.png')",c = "url('../../images/hatch/project/next-01.png')",d = "url('../../images/hatch/project/next-02.png')",e = "cursor",f = "default",g = "pointer",n = this._itemDoms.length;
                0 === n ? ($('.sliderTV__prev').css(i,b).css(e,f), $('.sliderTV__next').css(i,d).css(e,f)) : 0 === this._focus ? ($('.sliderTV__prev').css(i,b).css(e,f), $('.sliderTV__next').css(i, c).css(e, g)) : this._focus === n -1 ? ($('.sliderTV__prev').css(i, a).css(e, g), $('.sliderTV__next').css(i,d).css(e,f)) : ($('.sliderTV__prev').css(i, a).css(e, g), $('.sliderTV__next').css(i, c).css(e, g))
            }
        }, _isItemExists: function (t) {
            return Boolean(this._itemDoms[t])
        }, _moveTo: function (i) {
            this._calculateMidPoint();
            var s, e = i.to, n = "canAnimate" in i ? i.canAnimate : !0, o = n ? this.options.animation.duration : 0, h = this.options.animation.easing, l = !0, a = this._focus;
            if ("move:next" === e ? a++ : "move:prev" === e ? a-- : "number" == typeof e ? a = e : l = !1, s = this._isItemExists(a), l && s && !this._isAnimationOn) {
                var _, m, u = t(this._itemDoms[a]), c = "move:next" === e ? 1 : -1, r = 1 === c ? "-=" : "+=";
                this.options.animation.isVertical === !1 ? (_ = u.outerWidth() / 2, m = (u.offset().left - this._midPoints.x + _) * c) : (_ = u.outerHeight() / 2, m = (u.offset().top - this._midPoints.y + _) * c), this._setFocus(a), this._updateBullets(), this._showHidePrevNext(), t(this.element).trigger("animation:start"), this.options.animation.isVertical === !1 ? this._itemDoms.each(function (i, s) {
                        this._isAnimationOn = !0, t(s).animate({left: r + m}, o, h, function () {
                            this._isAnimationOn = !1, t(this.element).trigger("animation:end")
                        }.bind(this))
                    }.bind(this)) : this._itemDoms.each(function (i, s) {
                        this._isAnimationOn = !0, t(s).animate({top: r + m}, o, h, function () {
                            this._isAnimationOn = !1, t(this.element).trigger("animation:end")
                        }.bind(this))
