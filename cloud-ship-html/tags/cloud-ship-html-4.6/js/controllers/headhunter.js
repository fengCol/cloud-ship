...
app.controller('headhunterController', ['$rootScope', '$scope', '$state','$modal', 'loginService','$interval','$cookies','$timeout','userService',
    function ($rootScope,$scope,$state,$modal,loginService,$interval,$cookies,$timeout,userService) {
                    ...
                    if (res.data.code == 0) {
                        ...
                        loginService.userLogin(vm.loginUp).then(function (res) {
                            ...
                            if (res.data.code == 0) {
                                ...
                                $state.go('app.headhunter',{reload:true});
        ...
        vm.loginGO = function () {
            ...
            if(vm.isLogin) {
                window.open('http://luoboduo.com/home');
            }else{
